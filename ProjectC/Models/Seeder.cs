...
public class Seeder
{
    ...
    Machine13, Machine14, Machine15, Machine16
        ...
        Account Account10 = new Account { AccountName = "Umar", AccountEmail = "UmarCompain@.Comp", AccountPhone = "0123456789", AccountPassword= Security.EncodePasswordToBase64("UmarPassword"), Department = department1, CustCompany = Company1, TypeAccount = Type2 };
        Account Account11 = new Account { AccountName = "Henk", AccountEmail = "HenkCompain@.Comp", AccountPhone = "0123456789", AccountPassword = Security.EncodePasswordToBase64("HenkPassword"), Department = department1, CustCompany = Company1, TypeAccount = Type2 };
        Account Account12 = new Account { AccountName = "Bink", AccountEmail = "BinkCompain@.Comp", AccountPhone = "0123456789", AccountPassword = Security.EncodePasswordToBase64("BinkPassword"), Department = department1, CustCompany = Company1, TypeAccount = Type2 };
        Account Account13 = new Account { AccountName = "Piet", AccountEmail = "PietCompain@.Comp", AccountPhone = "0123456789", AccountPassword = Security.EncodePasswordToBase64("PietPassword"), Department = department2, CustCompany = Company2, TypeAccount = Type2 };
        Account Account14 = new Account { AccountName = "Sam", AccountEmail = "SamCompain@.Comp", AccountPhone = "0123456789", AccountPassword = Security.EncodePasswordToBase64("SamPassword"), Department = department2, CustCompany = Company2, TypeAccount = Type2 };
        Account Account15 = new Account { AccountName = "Sem", AccountEmail = "SemCompain@.Comp", AccountPhone = "0123456789", AccountPassword = Security.EncodePasswordToBase64("SemPassword"), Department = department2, CustCompany = Company2, TypeAccount = Type2 };
        Account Account16 = new Account { AccountName = "Klaas", AccountEmail = "KlaasCompain@.Comp", AccountPhone = "0123456789", AccountPassword = Security.EncodePasswordToBase64("KlaasPassword"), Department = department3, CustCompany = Company2, TypeAccount = Type2 };
        Account Account17 = new Account { AccountName = "Siebe", AccountEmail = "SiebeCompain@.Comp", AccountPhone = "0123456789", AccountPassword = Security.EncodePasswordToBase64("SiebePassword"), Department = department3, CustCompany = Company3, TypeAccount = Type2 };
        Account Account18 = new Account { AccountName = "Tymo", AccountEmail = "TymoCompain@.Comp", AccountPhone = "0123456789", AccountPassword = Security.EncodePasswordToBase64("TymoPassword"), Department = department3, CustCompany = Company3, TypeAccount = Type2 };
