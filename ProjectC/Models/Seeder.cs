...
public class Seeder
{
    ...
    Machine13, Machine14, Machine15, Machine16
        ...
        {
            new Ticket { CreatorID = Account10.AccountID, SolverID = Account1.AccountID, MachineID = 2, TicketDate = DateTime.UtcNow, TicketPhoto = null, TicketName = "Some Problem" , TicketMessage = "Ergens een probleem", Status = true, TriedExplanation = "You have to do this and dat", ExpectedResultExplanation = "I just want to work lets be fair", HowToFixExplanation = "throw it in water lol", },
            new Ticket { CreatorID = Account11.AccountID, SolverID = Account2.AccountID, MachineID = 1, TicketDate = DateTime.UtcNow, TicketPhoto = null, TicketName = "Some Problem" , TicketMessage = "Ergens een probleem",  Status = true, TriedExplanation = "You have to do this and dat", ExpectedResultExplanation = "I just want to work lets be fair", HowToFixExplanation = "throw it in water lol"},
            new Ticket { CreatorID = Account12.AccountID, SolverID = Account3.AccountID, MachineID = 1, TicketDate = DateTime.UtcNow, TicketPhoto = null, TicketName = "Some Problem" , TicketMessage = "Ergens een probleem", Status = true, TriedExplanation = "You have to do this and dat", ExpectedResultExplanation = "I just want to work lets be fair", HowToFixExplanation = "throw it in water lol"},
            new Ticket { CreatorID = Account13.AccountID, SolverID = Account4.AccountID, MachineID = 2, TicketDate = DateTime.UtcNow, TicketPhoto = null, TicketName = "Some Problem" , TicketMessage = "Ergens een probleem" , Status = true, TriedExplanation = "You have to do this and dat", ExpectedResultExplanation = "I just want to work lets be fair", HowToFixExplanation = "throw it in water lol"},
            new Ticket { CreatorID = Account14.AccountID, SolverID = Account5.AccountID, MachineID = 3, TicketDate = DateTime.UtcNow, TicketPhoto = null, TicketName = "Some Problem" , TicketMessage = "Ergens een probleem", Status = true, TriedExplanation = "You have to do this and dat", ExpectedResultExplanation = "I just want to work lets be fair", HowToFixExplanation = "throw it in water lol"},
            new Ticket { CreatorID = Account15.AccountID, SolverID = Account6.AccountID, MachineID = 4, TicketDate = DateTime.UtcNow, TicketPhoto = null, TicketName = "Some Problem" , TicketMessage = "Ergens een probleem", Status = true, TriedExplanation = "You have to do this and dat", ExpectedResultExplanation = "I just want to work lets be fair", HowToFixExplanation = "throw it in water lol"},
            new Ticket { CreatorID = Account16.AccountID, SolverID = Account7.AccountID, MachineID = 2, TicketDate = DateTime.UtcNow, TicketPhoto = null, TicketName = "Some Problem" , TicketMessage = "Ergens een probleem", Status = true, TriedExplanation = "You have to do this and dat", ExpectedResultExplanation = "I just want to work lets be fair", HowToFixExplanation = "throw it in water lol"},
        });
