...
public class Seeder
{
    ...
    Machine13, Machine14, Machine15, Machine16
        ...
        Account Account10 = new Account { AccountName = "Umar", AccountEmail = "UmarPassword", AccountPhone = "0123456789", AccountPassword= Security.EncodePasswordToBase64("UmarCompain@.Comp"), Department = null, CustCompany = Company1, TypeAccount = Type2 };
        Account Account11 = new Account { AccountName = "Henk", AccountEmail = "HenkPassword", AccountPhone = "0123456789", AccountPassword = Security.EncodePasswordToBase64("HenkCompain@.Comp"), Department = null, CustCompany = Company1, TypeAccount = Type2 };
        Account Account12 = new Account { AccountName = "Bink", AccountEmail = "BinkPassword", AccountPhone = "0123456789", AccountPassword = Security.EncodePasswordToBase64("BinkCompain@.Comp"), Department = null, CustCompany = Company1, TypeAccount = Type2 };
        Account Account13 = new Account { AccountName = "Piet", AccountEmail = "PietPassword", AccountPhone = "0123456789", AccountPassword = Security.EncodePasswordToBase64("PietCompain@.Comp"), Department = null, CustCompany = Company2, TypeAccount = Type2 };
        Account Account14 = new Account { AccountName = "Sam", AccountEmail = "SamPassword", AccountPhone = "0123456789", AccountPassword = Security.EncodePasswordToBase64("SamCompain@.Comp"), Department = null, CustCompany = Company2, TypeAccount = Type2 };
        Account Account15 = new Account { AccountName = "Sem", AccountEmail = "SemPassword", AccountPhone = "0123456789", AccountPassword = Security.EncodePasswordToBase64("SemCompain@.Comp"), Department = null, CustCompany = Company2, TypeAccount = Type2 };
        Account Account16 = new Account { AccountName = "Klaas", AccountEmail = "KlaasPassword", AccountPhone = "0123456789", AccountPassword = Security.EncodePasswordToBase64("KlaasCompain@.Comp"), Department = null, CustCompany = Company2, TypeAccount = Type2 };
        Account Account17 = new Account { AccountName = "Siebe", AccountEmail = "SiebePassword", AccountPhone = "0123456789", AccountPassword = Security.EncodePasswordToBase64("SiebeCompain@.Comp"), Department = null, CustCompany = Company3, TypeAccount = Type2 };
        Account Account18 = new Account { AccountName = "Tymo", AccountEmail = "TymoPassword", AccountPhone = "0123456789", AccountPassword = Security.EncodePasswordToBase64("TymoCompain@.Comp"), Department = null, CustCompany = Company3, TypeAccount = Type2 };
